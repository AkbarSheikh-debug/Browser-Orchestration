...
// what order the nodes should run in, and walks them — driving one Browserbase
// session across every browser step and publishing progress as it goes.
export const runWorkflowTask = task({
  ...
  run: async ({ workflowId, orgId }: { workflowId: string; orgId: string }) => {
    ...
    // The LLM routes through Browserbase's Model Gateway (BROWSERBASE_API_KEY),
